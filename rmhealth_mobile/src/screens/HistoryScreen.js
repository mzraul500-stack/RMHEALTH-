...
const TEXTS = {
  es: {
    ...
    subtitle: 'Registro de métricas de salud por fecha.',
    loading: 'Cargando...',
    empty_title: 'Sin Registros',
    empty_text: 'Aún no has registrado métricas de salud.',
    sos_label: '🚨 Alerta',
    ml: 'Patrón', score: 'Índice',
  ...
  en: {
    ...
    subtitle: 'Health metrics log by date.',
    loading: 'Loading...',
    empty_title: 'No Records',
    empty_text: 'No health metrics recorded yet.',
    sos_label: '🚨 Alert',
    ml: 'Pattern', score: 'Index',
    synced: 'Sync', local: 'Local',
    export_btn: '📤 Export',
