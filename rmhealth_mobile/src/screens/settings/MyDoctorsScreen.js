...
const TEXTS = {
  es: {
    ...
    subtitle: 'Especialistas y cuidadores vinculados a tu cuenta',
    linkDoctor: 'Vincular Contacto',
    enterCode: 'Ingresa el código de invitación',
    codePlaceholder: 'Ej: AB3K9X2M',
    link: 'Vincular',
    cancel: 'Cancelar',
    noLinks: 'No tienes contactos vinculados. Solicita un código de invitación a tu especialista.',
    revokeTitle: 'Revocar acceso',
    revokeMsg: 'Este contacto ya no podrá ver tus datos de bienestar.',
    confirm: 'Confirmar',
    active: 'Activo',
    pending: 'Pendiente',
    doctor: 'Especialista',
  ...
  en: {
    ...
    subtitle: 'Specialists and caregivers linked to your account',
    linkDoctor: 'Link Contact',
    enterCode: 'Enter the invitation code',
    codePlaceholder: 'Ex: AB3K9X2M',
    link: 'Link',
    cancel: 'Cancel',
    noLinks: 'No contacts linked. Ask your specialist for an invitation code.',
    revokeTitle: 'Revoke access',
    revokeMsg: 'This contact will no longer be able to see your wellness data.',
    confirm: 'Confirm',
    active: 'Active',
    pending: 'Pending',
    doctor: 'Specialist',
